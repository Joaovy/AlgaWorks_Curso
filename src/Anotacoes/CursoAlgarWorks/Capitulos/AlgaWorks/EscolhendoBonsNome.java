...
public class EscolhendoBonsNome {
    ...
    public static void main(String[] args) {
       ...
       String formasPagamentoEscolhida = receberFormaPagamentoDoUsuario(scanner);

        imprimirTraco();

        imprimir("O curso escolhido foi " + cursoEscolhido + " e a forma de pagamento é " + formasPagamentoEscolhida);
    ...
    static String receberCursoDoUsuario(Scanner scanner){
        ...
        Integer posicaoCursoEscolhido = receberIndiceValidoDoUsuario(cursos, "O curso que vocçê deseja: ", scanner);
